    ...
    <>
      ...
      <div className='content textColorGray'>
        ...
        <Box className='whiteBox' sx={whiteBoxStyle}>
          ...
          <Stack direction={{ xs: "column", sm: "column", md: "column", lg: "row", xl: "row" }} spacing={4} className='marginTop15'>
          <Box>
            <p className='subHeaders'> Pre-primary </p>
            <Stack direction={{ xs: "column", sm: "row", md: "row", lg: "row", xl: "row" }} spacing={4} className='menuFont marginTop15'>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={preprimaryBoy} className='pboy uniform' />
              </Box>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={preprimaryGirl} className='pgirl pboy uniform' />
              </Box>
            </Stack>
          </Box>
          <Box>
            ...
            <Stack direction={{ xs: "column", sm: "row", md: "row", lg: "row", xl: "row" }} spacing={4} className='menuFont marginTop15'>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={primaryBoy} className='pboy uniform' />
              </Box>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={primaryGirl} className='pgirl pboy uniform' />
              </Box>
            </Stack>
          </Box>
          <Box>
            ...
            <Stack direction={{ xs: "column", sm: "row", md: "row", lg: "row", xl: "row" }} spacing={4} className='menuFont marginTop15'>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={secondaryBoy} className='sboy pboy uniform' />
              </Box>
              <Box sx={{ width: "200 px", height: "354px" }}>
                <img src={secondaryGirl} className='sgirl pboy uniform' />
              </Box>
            </Stack>
          </Box>
          </Stack>
